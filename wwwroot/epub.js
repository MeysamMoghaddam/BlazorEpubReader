...
this.book.spine.get = function(target) {            
    ...
    while ((t == null) && target.toString().startsWith("../")) {         
...
var IframeView = function () {
	...
	_createClass(IframeView, [{
		...
		value: function highlight(cfiRange,color) {
			...
			var m = new _marksPane.Highlight(range, "epubjs-hl", data, { 'fill': arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'yellow', 'fill-opacity': '0.3', 'mix-blend-mode': 'multiply' });
